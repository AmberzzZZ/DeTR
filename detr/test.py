...
if __name__ == '__main__':
    ...
    model = detr(input_shape=(800,1200,3), pe='sine', n_classes=92, depth=50, dilation=False,
                 emb_dim=256, enc_layers=6, dec_layers=6, max_boxes=100, mode='test')
    ...
    for file in os.listdir(data_dir):
        ...
        mask = np.zeros((1,800,1200,1))    # img_mask, mask=1 represents useless edges

        preds = model.predict([inpt,mask])
